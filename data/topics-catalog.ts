  ...
  },
{
  ...
  },
  {
    ...
    description: "Build an indicator list, set a threshold, and warn while a decision still exists.",
    image: "/indicators-warnings.png",
    href: "/topics/indicators-warnings",
    category: "Strategic Intelligence",
    estimatedTime: "18 min",
    completed: false,
    learningObjectives: [
      "Distinguish indicators, signposts, and forecasts.",
      "Set watch and warning thresholds against a baseline.",
      "Write a warning product that states what would reverse the call.",
    ],
  },
  {
    title: "Long-Term Threats and Opportunities",
    dateAdded: "2026-09-23",
    description: "Separate drivers from headlines and write a horizon a planner can use.",
    ...
    completed: false,
    learningObjectives: [
      "Sort events, conditions, and drivers.",
      "Match a driver to a one-year, five-year, or ten-year question.",
      "Pair a threat scan with an opportunity and a wildcard indicator.",
    ],
  },
  {
    title: "Intelligence Gap Analysis",
    dateAdded: "2026-09-23",
    description: "Name the unknown that changes a decision before you write a requirement.",
    image: "/intelligence-collection-planning-thumb.png",
    href: "/topics/intelligence-gap-analysis",
    category: "Collection",
    estimatedTime: "16 min",
    completed: false,
    learningObjectives: [
      "Write a gap statement tied to a decision and a date.",
      "Separate collectable gaps from accepted uncertainty.",
      "Keep a register that closes.",
    ],
  },
  {
    title: "Matching Sources to Requirements",
    dateAdded: "2026-09-23",
    description: "Let the question pick the discipline, and record the blind spot.",
    ...
    completed: false,
    learningObjectives: [
      "Match an information need to a discipline you are allowed to task.",
      "Identify single-source risk before the briefing writes itself.",
      "Rule a source out for authority or access, not for taste.",
    ],
  },
  {
    title: "Writing Collection Tasks",
    dateAdded: "2026-09-23",
    description: "Hand a collector one question, a clock, and a definition of a negative result.",
    image: "/collection-management.png",
    ...
    completed: false,
    learningObjectives: [
      "Separate a requirement, a plan, and a task.",
      "Write scope, time window, and return format a collector can execute.",
      "Avoid tasking the verdict.",
    ],
  },
  {
    title: "Evaluating Collection Plans",
    dateAdded: "2026-09-23",
    description: "Score the gap, not the bustle, then retask, narrow, or stop.",
    image: "/data-collection-roadmap.png",
    href: "/topics/evaluating-collection-plans",
    category: "Collection",
    estimatedTime: "15 min",
    completed: false,
    learningObjectives: [
      "Evaluate coverage, timeliness, and source independence.",
      "Tell a negative result from silence.",
      "Choose retask, narrow, or stop and tell the requirement owner.",
    ],
  },
  {
    title: "Threat Prioritization",
    dateAdded: "2026-09-23",
    description: "Rank threats by likelihood, impact, and time to intervene.",
    image: "/emerging-threats-thumb.png",
    href: "/topics/threat-prioritization",
    category: "Threat Assessment",
    estimatedTime: "16 min",
    completed: false,
    learningObjectives: [
      "State the resource a priority list is spending.",
      "Score residual risk given controls that already exist.",
      "Defend or revise the order when the room disagrees.",
    ],
  },
  {
    title: "Mitigation Options",
    dateAdded: "2026-09-23",
    description: "Turn an assessment into accept, monitor, reduce, transfer, or avoid — with the leftover risk named.",
    ...
    completed: false,
    learningObjectives: [
      "Separate judgment, implication, and option.",
      "Match a treatment to the factor it actually changes.",
      "Name the owner and the residual risk.",
    ],
  },
  {
    title: "Behavioral Threat Assessment",
    dateAdded: "2026-09-23",
    description: "Document observable behavior, cap the judgment, and refer to the authority that can act.",
    image: "/behavioral-analysis-grid.png",
    href: "/topics/behavioral-assessment",
    category: "Threat Assessment",
    estimatedTime: "17 min",
    completed: false,
    learningObjectives: [
      "Assess behavior rather than a stereotype or a guessed diagnosis.",
      "Record which steps on a pathway are missing.",
      "Write a referral that does not become an operational how-to.",
    ],
  },
];
