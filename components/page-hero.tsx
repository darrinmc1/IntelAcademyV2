...
interface PageHeroProps {
  title: string
  /** Portion of the title rendered with the cyan→indigo gradient */
  accentTitle?: string
  subtitle?: string
...
/**
 * Consistent dark hero banner used at the top of every content page.
 * Matches the site's slate/cyan/indigo design language.
 */
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-4">
          ...
          {accentTitle && (
            <>
              {" "}
              <span className="text-gradient-primary">{accentTitle}</span>
            </>
          )}
        </h1>
        ...
        {/* Optional slot for CTAs / search bars etc */}
