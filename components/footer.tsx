        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/feedback" className="text-slate-400 hover:text-cyan-400 transition-colors duration-300 font-light flex items-center gap-2 group"><span className="w-1.5 h-1.5 rounded-full bg-cyan-500/50 group-hover:bg-cyan-400 transition-colors" />Report a problem</Link></li>
