  ...
  return (
    <footer className="py-12 mt-auto border-t border-white/10 bg-slate-950 relative overflow-hidden z-10">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/learning-paths/foundations" className="text-slate-400 hover:text-cyan-400 hover:pl-2 transition-all duration-300 font-light">Foundations</Link></li>
              <li><Link href="/learning-paths/strategic-intelligence" className="text-slate-400 hover:text-cyan-400 hover:pl-2 transition-all duration-300 font-light">Strategic Intelligence</Link></li>
              <li><Link href="/learning-paths/tactical-intelligence" className="text-slate-400 hover:text-cyan-400 hover:pl-2 transition-all duration-300 font-light">Tactical Intelligence</Link></li>
              <li><Link href="/learning-paths/osint" className="text-slate-400 hover:text-cyan-400 hover:pl-2 transition-all duration-300 font-light">OSINT</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/pricing" className="text-slate-400 hover:text-cyan-400 hover:pl-2 transition-all duration-300 font-light">Coming soon</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/request-topic" className="text-slate-400 hover:text-cyan-400 transition-colors duration-300 font-light flex items-center gap-2 group"><span className="w-1.5 h-1.5 rounded-full bg-indigo-500/50 group-hover:bg-indigo-400 transition-colors" />Request a new topic</Link></li>
              <li><Link href="/feedback" className="text-slate-400 hover:text-cyan-400 transition-colors duration-300 font-light flex items-center gap-2 group"><span className="w-1.5 h-1.5 rounded-full bg-cyan-500/50 group-hover:bg-cyan-400 transition-colors" />Feedback</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="https://peelboss.com" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-cyan-400 hover:pl-2 transition-all duration-300 font-light">PeelBoss</a></li>
              <li><a href="https://freelancepro-teal.vercel.app" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-cyan-400 hover:pl-2 transition-all duration-300 font-light">FreelancePro</a></li>
              <li><a href="https://aiforsmb.vercel.app" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-cyan-400 hover:pl-2 transition-all duration-300 font-light">AI for SMB</a></li>
              <li><a href="https://abcofcyber.com" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-cyan-400 hover:pl-2 transition-all duration-300 font-light">ABC of Cyber</a></li>
              <li><a href="https://moneymastery.vercel.app" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-cyan-400 hover:pl-2 transition-all duration-300 font-light">Money Mastery</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center text-slate-500 font-light flex flex-col md:flex-row justify-between items-center gap-4">
