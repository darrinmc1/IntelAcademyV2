...
import { ArrowRight, ClipboardList, FileSearch, ShieldCheck, Swords } from "lucide-react"
...
export const metadata: Metadata = {
  title: "Analyst Tools",
  description:
    "Academy Brief: paste a raw intel dump and get a structured brief using the academy method. Plus report, source, and threat tools.",
}
...
const tools = [
  {
    ...
    name: "Academy Brief",
    description:
      "One job: paste a raw intel dump or notes and receive a structured brief using the academy method, citing real catalog topics and lessons.",
    icon: ClipboardList,
    ...
    <div className="mx-auto max-w-6xl px-4 py-16">
      <div className="mb-12 text-center">
        ...
        <p className="mt-4 text-lg text-slate-400">
          Academy Brief is the one-job layer: dump in, structured brief out, with citations to real lessons.
        </p>
      </div>
      ...
      <div className="mt-16 rounded-xl border border-slate-800 bg-slate-900/30 p-8 text-center space-y-3">
        <p className="text-sm text-slate-400">
          <span className="font-semibold text-slate-300">Free:</span> one Academy Brief preview.{" "}
          <Link href="/pricing" className="text-amber-400 underline underline-offset-2 hover:text-amber-300">
            Paid plans
          </Link>{" "}
          include the tool ($5–$10/mo) or standalone $29/mo when billing is live.
        </p>
