  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center mb-8 rounded-lg overflow-hidden bg-white/5 border border-white/10">
        <div className="relative h-64 w-full bg-gradient-to-r from-purple-900 to-purple-700"></div>
        <div className="p-8 text-white">
          <h2 className="text-3xl font-bold mb-3">OSINT Learning Path</h2>
          <p className="text-slate-300 max-w-md">Learn how to gather, analyze, and leverage open-source intelligence effectively</p>
        </div>
      </div>
