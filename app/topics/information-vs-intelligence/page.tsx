...
Answers "What?" (like a toddler's first question)
...
**Information:** "The temperature is 75°F. The humidity is 85%. The barometric pressure is
falling. Clouds are moving in from the west."

**Intelligence:** "There's a 90% chance of rain this afternoon. Bring an umbrella if you're
...
**Information:** "Company X has leased a large facility in Singapore. They've hired 15
engineers with semiconductor experience. Their CEO visited Taiwan twice last month."

**Intelligence:** "Company X is likely entering the semiconductor market with a focus on
...
**Information:** "Subject A purchased large quantities of fertilizer. Subject A has visited
websites about explosives. Subject A has no agricultural background."

**Intelligence:** "Subject A shows several indicators consistent with potential bomb-making
...
**Impact:** The intelligence allows police to deploy targeted patrols during specific
...
Sales data showing a 15% decrease in a product line over the last quarter.
...
**Impact:** This intelligence allows the company to make informed decisions about product
...
**Impact:** This intelligence allows national security decision-makers to respond
  ...
  return (
    <LessonContainer>
      <MicroLesson
        ...
        subtitle="Learn the critical differences between raw information and processed intelligence, and why this distinction matters for "
      ...
      >
        <EnhancedLessonContentLoader content={topicContent} topic="information-vs-intelligence" />
      </MicroLesson>
    </LessonContainer>
  )
}
