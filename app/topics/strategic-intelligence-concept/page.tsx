  ...
  return (
    <LessonContainer>
      <MicroLesson
        ...
        subtitle="Understand the fundamental principles and applications of strategic intelligence in national security and organizational decision-making."
        humorSubtitle="Playing chess with world events while others still play checkers"
        readTime={18}
        difficulty="Advanced"
        category="Strategic Intelligence"
        mascot="osint"
        mascotMessage="Welcome, strategist. Today you learn to see beyond the present and shape the future."
      >
