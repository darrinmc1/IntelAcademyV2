...
- **USA FREEDOM Act (2015):** Ended bulk
...
### The Geneva Conventions and Armed Conflict
...
### The Tallinn Manual and Cyber Operations
...
- Identify which domestic laws and constitutional provisions are relevant to this scenario.
- Determine whether a FISA warrant is required and why.
- Identify any international law constraints (diplomatic immunity, sovereignty).
- Map which oversight bodies would have visibility into this operation.
  ...
  return (
    <LessonContainer>
      <MicroLesson
        ...
        subtitle="Explore the legal frameworks, statutes, and international laws that govern intelligence activities and define the bounda"
      ...
      >
        <EnhancedLessonContentLoader content={topicContent} topic="legal-frameworks" />
      </MicroLesson>
    </LessonContainer>
  )
}
