  ...
  return (
    <LessonContainer>
      <MicroLesson
        ...
        subtitle="Someone Has to Watch the Watchers. Turns Out That's a Whole Department."
        humorSubtitle="Someone has to watch the watchers. Turns out that's a whole department."
        readTime={25}
        difficulty="Intermediate"
        category="Intelligence Ethics"
        mascot="intelligence-ethics"
        mascotMessage="Oversight isn't about distrust, recruit. It's about building a system where trust doesn't need to be blind."
      >
        <MissionBriefing humorText="Intelligence oversight is the art of making sure the people with the most secrets don't keep too many secrets from the people who are supposed to be watching them. It is more complicated than it sounds.">
          <p className="mb-4">
        ...
        <DeepDive title="Why Oversight Exists: Preventing Abuse and Maintaining Trust">
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">The Historical Roots of Oversight</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">The Democratic Paradox of Secrecy</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">The Tension Between Effectiveness and Accountability</h3>
          <p className="mb-4">
        ...
        <DeepDive title="Executive Oversight Mechanisms: Watching from Within">
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">The Privacy and Civil Liberties Oversight Board (PCLOB)</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">Inspectors General: The Internal Watchdogs</h3>
          <p className="mb-4">
        ...
        <DeepDive title="Congressional Oversight: The Power of the Purse and the Subpoena">
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">HPSCI and SSCI: The Intelligence Committees</h3>
          <p className="mb-4">
          ...
          <div className="bg-slate-800/50 border border-white/10 rounded-lg p-4 mb-6">
            <p className="text-slate-400 text-xs uppercase tracking-widest font-bold mb-2">Key Congressional Oversight Powers</p>
            <ul className="space-y-2 text-slate-300 text-sm">
              <li>
                <strong className="text-white">Budget Authority:</strong> Congress controls the
              ...
              <li>
                <strong className="text-white">Covert Action Notification:</strong> The Intelligence
              ...
              <li>
                <strong className="text-white">Confirmation Authority:</strong> The Senate confirms
              ...
              <li>
                <strong className="text-white">Investigations and Hearings:</strong> Committees can
              ...
              <li>
                <strong className="text-white">Legislation:</strong> Congress can amend or rewrite
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">The Limitations of Congressional Oversight</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">The Intelligence Budget: Following the Money</h3>
          <p className="mb-4">
        ...
        <DeepDive title="International and Comparative Oversight: How Other Democracies Do It">
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">The United Kingdom: Investigatory Powers and IPCO</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">The European Union: Data Protection and the EDPS</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">Canada: The SIRC Model</h3>
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">Australia: The IGIS Model</h3>
          <p className="mb-4">
          ...
          <div className="bg-slate-800/50 border border-white/10 rounded-lg p-4 mb-6">
            <p className="text-slate-400 text-xs uppercase tracking-widest font-bold mb-2">Comparative Oversight Models: Key Features</p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-slate-300">
                <thead>
                  <tr className="border-b border-white/10 text-left">
                    <th className="py-2 pr-4 font-semibold text-white">Country</th>
                    <th className="py-2 pr-4 font-semibold text-white">Primary Body</th>
                    <th className="py-2 pr-4 font-semibold text-white">Type</th>
                    <th className="py-2 font-semibold text-white">Key Strength</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">United States</td>
                    <td className="py-2 pr-4">HPSCI / SSCI / PCLOB / IGs</td>
                    <td className="py-2 pr-4">Multi-layered</td>
                    <td className="py-2">Budget power, multiple bodies</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">United Kingdom</td>
                    <td className="py-2 pr-4">IPCO / IPT</td>
                    <td className="py-2 pr-4">Judicial</td>
                    <td className="py-2">Pre-authorization by judges</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">Canada</td>
                    <td className="py-2 pr-4">SIRC / NSIRA</td>
                    <td className="py-2 pr-4">Independent review</td>
                    <td className="py-2">Own-initiative investigations</td>
                  </tr>
                  <tr>
                    <td className="py-2 pr-4">Australia</td>
                    <td className="py-2 pr-4">IGIS</td>
                    <td className="py-2 pr-4">Single statutory officer</td>
                    <td className="py-2">Deep expertise, all-agency scope</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <FieldExercise title="Oversight System Design Exercise">
          <p className="mb-4">
          ...
          <ol className="list-decimal list-inside space-y-2 text-slate-300 mb-4">
            <li>Design a three-part oversight system with legislative, executive, and independent components.</li>
            <li>For each component, specify: composition, appointment process, powers, resources, and reporting requirements.</li>
            <li>Identify the key design choices where your system could go wrong — and explain how you would address each risk.</li>
            <li>Compare your design with the U.S., UK, Canadian, and Australian models. What did you borrow from each? What did you reject?</li>
            <li>Write a one-paragraph summary of your oversight system that you could present to the country's new parliament.</li>
          </ol>
        ...
        <Debrief
          takeaways={[
            "Oversight exists to prevent abuse of power and maintain public trust — both essential for the legitimacy and effectiveness of democratic intelligence agencies.",
            "The Church Committee investigations of the 1970s revealed systemic intelligence abuses and led to the modern oversight architecture in the United States.",
            "Executive oversight mechanisms — PCLOB, Inspectors General, ODNI — provide internal accountability but face inherent conflicts of interest as part of the executive branch.",
            "Congressional oversight — through HPSCI, SSCI, budget authority, and covert action notification — is the most powerful check on intelligence power, subject to political dynamics.",
            "Comparative analysis reveals multiple models: judicial (UK), independent review (Canada), single statutory officer (Australia), and multi-layered (U.S.) — each with distinct trade-offs.",
            "The effectiveness of any oversight system depends on three factors: independence from the agencies being overseen, access to necessary information, and authority to compel change.",
          ]}
          humorSummary="Oversight is the intelligence community's way of acknowledging that giving people secret powers and hoping they behave is not a strategy — it is a gamble, and history says you will lose."
        />
      </MicroLesson>
      ...
      <WhatsNext
        ...
        moreLearning={{
          ...
          description: "The laws and regulations that govern intelligence activities.",
          path: "/topics/legal-frameworks",
        }}
        advancedLearning={{
          title: "Privacy and Civil Liberties",
          description: "Understanding the balance between intelligence needs and individual rights.",
