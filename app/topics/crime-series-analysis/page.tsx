  ...
  return (
    <LessonContainer>
      <MicroLesson
        ...
        subtitle="Learn techniques for analyzing crime series and patterns."
        humorSubtitle="Connect the dots before the bad guys do"
        readTime={25}
        difficulty="Intermediate"
        category="Operational Intelligence"
        mascot="analysis"
        mascotMessage="Welcome to the investigation. Each crime tells a story—let's learn to read them all together."
      >
