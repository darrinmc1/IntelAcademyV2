  ...
  return (
    <LessonContainer>
      <MicroLesson
        ...
        readTime={15}
      >
        <MissionBriefing humorText="The secret agency wants YOU to explore the ethical considerations and dilemmas in intelligence work and navigate them responsibly—without ending up in congressional hearings.">
          <p className="mb-4">
        ...
        <DeepDive title="Ethics: The Guardrails That Keep Intelligence From Going Off a Cliff">
          <p className="mb-4">
        ...
        <DeepDive title="When Intelligence Goes Wrong: Ethical Failures and Their Consequences">
        ...
        <DeepDive title="The Ethical Decision-Making Framework: More Than Just a CYA Exercise">
        ...
        <DeepDive title="Conclusion: Ethics as a Strength, Not a Constraint">
        ...
        <Debrief
          takeaways={[
            "Ethics isn't a constraint on intelligence work—it's what makes intelligence work legitimate and effective",
            "The key principles are necessity, proportionality, discrimination, and accountability",
            "Ethical dilemmas don't have perfect answers, but frameworks help you make defensible decisions",
            "Intelligence failures show us that unethical practices create more problems than they solve",
          ]}
          humorSummary="When policymakers ask why your ethical guidelines are slowing things down, remind them that 'ethical breaches followed by congressional hearings' is much slower than 'doing it right the first time.'"
        />
      </MicroLesson>
