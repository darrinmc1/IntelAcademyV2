...
### The Consequences of Unethical Action

Consider the real-world consequences of unethical intelligence practices:

- **Loss of Public Trust:** When the Church
...
- **Unreliable Intelligence:** Information
...
- **Legal Restrictions:** Every major ethics
...
- **Damage to Partnerships:** Allies do not
...
- **Moral Injury to Personnel:** Intelligence
...
### The Ethical Imperative Is Also a Practical Imperative
...
Utilitarianism in Practice: The Ticking Time Bomb
...
### Deontology: Rules, Duties, and Rights
...
### Virtue Ethics: Character, Judgment, and the Good Analyst
...
- **1. Identify the Ethical Issues:** What values,
...
- **2. Gather the Facts:** What do you actually
...
- **3. Identify Stakeholders:** Who will be
...
- **4. Evaluate Options:** What are the possible
...
- **5. Make a Decision and Act:** Based on your
...
- **6. Reflect and Learn:** After the fact,
...
- **Groupthink:** Assuming the group's consensus is ethically sound.
...
### Case Study 1: The Tainted Source
...
**Questions for analysis:** Does the imminent threat change the ethical
...
### Case Study 2: The Friendly Target
...
important diplomatic relationship. Not using it would mean failing to act on
intelligence that affects national interests.

**Questions for analysis:** Does the legality of the collection mean it
...
### Case Study 3: The Algorithmic Bias
...
**Questions for analysis:** Does the unintentional nature of the bias
...
- Identify the ethical issues raised by monitoring the officer through their child's social media.
- Identify all stakeholders affected by this decision.
- Apply all three ethical frameworks (utilitarianism, deontology, virtue ethics) to evaluate the proposal.
- Using the six-step model, determine what decision you would make and document your reasoning.
- Present your decision and reasoning as if briefing your agency's general counsel.
  ...
  return (
    <LessonContainer>
      <MicroLesson
        ...
        subtitle="Learn frameworks and models for making ethical decisions in intelligence work, from classic ethical theories to practica"
      ...
      >
        <EnhancedLessonContentLoader content={topicContent} topic="ethical-decision-making" />
      </MicroLesson>
    </LessonContainer>
  )
}
