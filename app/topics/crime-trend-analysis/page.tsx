  ...
  return (
    <LessonContainer>
      <MicroLesson
        ...
        subtitle="Explore methods and techniques for analyzing crime trends and patterns over time."
        humorSubtitle="Predicting tomorrow's trouble by studying yesterday's crimes"
        readTime={25}
        difficulty="Intermediate"
        category="Operational Intelligence"
        mascot="analysis"
        mascotMessage="Welcome, analyst. The past whispers secrets about the future—learn to listen."
      >
