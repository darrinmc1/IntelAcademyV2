  ...
  return (
    <LessonContainer>
      <MicroLesson
        ...
        subtitle="Because 'I Swear I Saw It on Their Facebook' Does Not Hold Up in Court"
        category="Report Writing"
        difficulty="Advanced"
        mascot="report-writing"
        readTime={19}
      >
        <MissionBriefing humorText="Digital evidence is fragile, fleeting, and frustratingly easy to mishandle. One wrong move and your smoking gun becomes a smoking pile of inadmissible data.">
          <p className="mb-4">
        ...
        <DeepDive title="The Digital Evidence Lifecycle">
          <p className="mb-4">
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">The Six Stages</h3>
          <ol className="list-decimal pl-6 mb-4 space-y-2">
            <li>
              <strong>Identification:</strong> Recognizing that digital evidence exists and is
            ...
            <li>
              <strong>Collection:</strong> Acquiring the evidence in a forensically sound manner.
              The golden rule: <strong>never work on the original.</strong> Create a forensic
              image and work on the copy.
            </li>
            <li>
              <strong>Preservation:</strong> Ensuring the evidence remains unaltered from
              collection through analysis through presentation. This is where hash values become
              your best friend.
            </li>
            <li>
              <strong>Analysis:</strong> Examining the evidence to extract intelligence value.
              Document every step -- every search, every filter, every tool used.
            </li>
            <li>
              <strong>Reporting:</strong> Presenting your findings in a format that is clear,
              accurate, and defensible. Include methodology, tools, and limitations.
            </li>
            <li>
              <strong>Disposition:</strong> What happens to the evidence when the case is closed?
        ...
        <DeepDive title="Forensic Imaging and Hash Verification">
          <h3 className="text-xl font-bold mb-3 mt-6">Forensic Imaging</h3>
          <p className="mb-4">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>
              <strong>Use write-blockers.</strong> Before imaging a device, connect it through a
            ...
            <li>
              <strong>Full disk image vs. logical image.</strong> A full disk image captures
            ...
            <li>
              <strong>Document the imaging process.</strong> Record the device make, model, serial
              number, the imaging tool and version used, the start and end time, and any errors
              encountered.
            </li>
          </ul>

          <h3 className="text-xl font-bold mb-3 mt-6">Hash Verification: MD5 and SHA</h3>
          <p className="mb-4">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>
              <strong>MD5 (Message Digest 5):</strong> Produces a 128-bit hash. Fast and widely
            ...
            <li>
              <strong>SHA-1:</strong> Produces a 160-bit hash. More secure than MD5 but also
              showing its age. Google demonstrated a SHA-1 collision in 2017.
            </li>
            <li>
              <strong>SHA-256:</strong> The current gold standard. Produces a 256-bit hash with no
              known practical collisions. Use this as your primary verification method.
            </li>
          </ul>
          <p className="mb-4">
            <strong>Best practice:</strong> Generate both MD5 and SHA-256 hashes at the time of
          ...
          <ProTip>
            <p>
              Always hash the original device <strong>before</strong> creating the forensic image,
        ...
        <DeepDive title="Metadata Preservation and Legal Admissibility">
          <h3 className="text-xl font-bold mb-3 mt-6">Metadata: The Evidence About the Evidence</h3>
          <p className="mb-4">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>
              <strong>File metadata:</strong> Creation date, modification date, last accessed
            ...
            <li>
              <strong>Email metadata:</strong> Full headers including Received fields, Message-ID,
              originating IP address, client information, and routing path.
            </li>
            <li>
              <strong>Image metadata (EXIF):</strong> Camera model, GPS coordinates, date/time,
            ...
            <li>
              <strong>Web page metadata:</strong> HTTP headers, server timestamps, caching
              information, SSL certificate details.
            </li>
          </ul>

          <h3 className="text-xl font-bold mb-3 mt-6">Legal Admissibility Standards</h3>
          <p className="mb-4">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>
              <strong>Authenticity:</strong> Can you prove the evidence is what you claim it is?
              Hash values, chain of custody logs, and forensic imaging reports establish
              authenticity.
            </li>
            <li>
              <strong>Integrity:</strong> Can you prove the evidence has not been altered? This is
              where your hash verification at every stage becomes critical.
            </li>
            <li>
              <strong>Reliability:</strong> Were the tools and methods used to collect and analyze
            ...
            <li>
              <strong>Proportionality:</strong> Was the collection method proportionate to the
        ...
        <DeepDive title="OSINT Documentation and Chain of Custody">
          <h3 className="text-xl font-bold mb-3 mt-6">Documenting OSINT: Screenshots Are Not Enough</h3>
          <p className="mb-4">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>
              <strong>Full-page screenshots with browser chrome.</strong> Capture the URL bar,
              timestamp, and browser interface -- not just the content area. This establishes when
              and where the content was observed.
            </li>
            <li>
              <strong>Archive the page.</strong> Use tools like the Wayback Machine, Archive.today,
            ...
            <li>
              <strong>Save the page source.</strong> HTML source code preserves hidden metadata,
              embedded links, and structural information that screenshots cannot capture.
            </li>
            <li>
              <strong>Record your methodology.</strong> Document the search terms, platforms,
              tools, and dates used. Another analyst should be able to retrace your steps.
            </li>
            <li>
              <strong>Hash your screenshots.</strong> Generate SHA-256 hashes of your screenshot
              files immediately after capture to prove they have not been altered.
            </li>
          </ul>

          <h3 className="text-xl font-bold mb-3 mt-6">Chain of Custody Procedures</h3>
          <p className="mb-4">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>
              <strong>Log every transfer.</strong> When evidence passes from one person to another
            ...
            <li>
              <strong>Secure storage.</strong> Digital evidence should be stored on encrypted,
              access-controlled media. A forensic image sitting on an unencrypted shared drive is
              a chain of custody nightmare.
            </li>
            <li>
              <strong>Access logs.</strong> Maintain logs of who accessed the evidence and when.
              Many forensic tools generate these automatically -- make sure the feature is enabled.
            </li>
            <li>
              <strong>Version control.</strong> If you create derivative products (extracted files,
          ...
          <h3 className="text-xl font-bold mb-3 mt-6">Common Documentation Failures</h3>
          <p className="mb-4">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>
              <strong>Failing to hash at the time of collection.</strong> Generating a hash days
              or weeks later proves the file has not changed since the hash was generated -- not
              since it was collected.
            </li>
            <li>
              <strong>Working on the original.</strong> Opening the original file, even just to
              "take a quick look," can alter metadata and break the evidentiary chain.
            </li>
            <li>
              <strong>Incomplete screenshots.</strong> Cropping out the URL bar or timestamp
              because "it looked cleaner" eliminates the very information that establishes
              provenance.
            </li>
            <li>
              <strong>Gaps in the chain of custody log.</strong> "I think Bob had the drive over
              the weekend" is not a chain of custody entry.
            </li>
            <li>
              <strong>Not documenting tools and versions.</strong> "I used some forensic tool" is
          ...
          <ProTip>
            <p>
              Create a <strong>digital evidence checklist</strong> and use it every single time.
      ...
      <WhatsNext
        ...
        advancedLearning={{
          ...
          path: "/topics/visual-intelligence-reporting",
        }}
      />
    </LessonContainer>
  )
