      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          <div className="prose max-w-none dark:prose-invert">
            ...
            <div className="bg-amber-500/10 p-4 rounded-lg border border-amber-500 my-6">
              <h3 className="text-amber-400 font-medium mb-2">Entity Chart Truth #1</h3>
            ...
            <div className="bg-cyan-500/10 p-4 rounded-lg border border-cyan-500 my-6">
              <h3 className="text-cyan-400 font-medium mb-2">The Entity Chart Paradox</h3>
              <p className="text-cyan-300 mb-0">
