...
const TOPIC_INDEX: TopicEntry[] = [
  { title: "What Is Tactical Intelligence?", description: "Fundamentals of tactical intelligence: timeframes, products, and compressed-cycle analysis.", category: "Tactical", path: "/topics/what-is-tactical-intelligence", keywords: ["tactical", "intelligence", "spot report", "warning", "operational"], content: "tactical intelligence spot report threat warning operators time sensitive" },
  { title: "Strategic vs. Tactical: What Analysts Must Understand", description: "How strategic, operational, and tactical intelligence differ and connect.", category: "Foundations", path: "/topics/strategic-vs-tactical-analysts", keywords: ["strategic", "tactical", "operational", "levels", "analyst"], content: "strategic tactical operational levels intelligence comparison analysts" },
  ...
  { title: "Indicators and Warnings", description: "Build indicator lists, thresholds, and strategic warnings while a decision still exists.", category: "Strategic", path: "/topics/indicators-warnings", keywords: ["indicators", "warnings", "threshold", "watch", "strategic"], content: "indicators warnings threshold watch condition strategic warning" },
  { title: "Long-Term Threats and Opportunities", description: "Identify drivers, conditions, and wildcards for long-range threat and opportunity assessments.", category: "Strategic", path: "/topics/long-term-threats", keywords: ["long-term", "drivers", "horizon", "opportunity", "wildcard"], content: "long term threats opportunities drivers horizon scanning wildcards" },
  { title: "Intelligence Gap Analysis", description: "Diagnose the specific unknown that changes a decision before you write a collection requirement.", category: "Collection", path: "/topics/intelligence-gap-analysis", keywords: ["gap", "requirements", "collection", "register", "unknowns"], content: "intelligence gap analysis register known unknowns collection" },
  { title: "Matching Sources to Requirements", description: "Choose a collection discipline against the question, and write down the blind spot.", category: "Collection", path: "/topics/matching-sources-to-requirements", keywords: ["sources", "requirements", "osint", "disciplines", "single-source"], content: "matching sources requirements disciplines single source collection planning" },
  { title: "Writing Collection Tasks", description: "Turn a requirement into a bounded task a collector can execute and a negative result can close.", category: "Collection", path: "/topics/writing-collection-tasks", keywords: ["tasking", "collection", "requirements", "collectors"], content: "writing collection tasks requirements negative results collectors" },
  { title: "Evaluating Collection Plans", description: "Score a collection plan by whether the gap was answered in time, then retask, narrow, or stop.", category: "Collection", path: "/topics/evaluating-collection-plans", keywords: ["evaluation", "collection", "feedback", "retask"], content: "evaluating collection plans feedback retask gap coverage" },
  { title: "Threat Prioritization", description: "Rank threats by likelihood, impact, and time to intervene when everything is called critical.", category: "Threat Assessments", path: "/topics/threat-prioritization", keywords: ["priority", "likelihood", "impact", "ranking", "threat"], content: "threat prioritization likelihood impact residual risk ranking" },
  { title: "Mitigation Options", description: "Turn a threat assessment into accept, monitor, reduce, transfer, or avoid — with residual risk named.", category: "Threat Assessments", path: "/topics/mitigation-strategies", keywords: ["mitigation", "residual", "controls", "options", "risk"], content: "mitigation strategies residual risk accept monitor reduce transfer avoid" },
  { title: "Behavioral Threat Assessment", description: "Document observable behavior, cap the judgment, and refer to the authority that can act.", category: "Threat Assessments", path: "/topics/behavioral-assessment", keywords: ["behavioral", "threat", "referral", "protective", "pathway"], content: "behavioral threat assessment referral pathway concern behavior protective" },
  { title: "Threat Assessment Methodologies", description: "Qualitative, quantitative, scenario, and hybrid methods for evaluating and prioritizing threats.", category: "Threat Assessments", path: "/topics/threat-assessment-methodologies", keywords: ["methodologies", "qualitative", "quantitative", "scenario", "threat"], content: "threat assessment methodologies qualitative quantitative scenario" },
  { title: "Deep Web Research", description: "Research the unindexed web with authorized sources, and keep it distinct from places you may not go.", category: "OSINT", path: "/topics/deep-web-research-for-intel-analysts", keywords: ["deep web", "osint", "databases", "research"], content: "deep web research osint databases authorized access" },
  { title: "Collection Planning Process", description: "The systematic process from requirements through tasking, monitoring, and evaluation.", category: "Collection", path: "/topics/collection-planning-process-for-intel-analysts", keywords: ["collection", "planning", "tasking", "process"], content: "collection planning process requirements tasking evaluation" },
]
